...
[{class:"background{fill: none}"},
{class:"chartholder{fill: none;}"},
{class:"title{font-size:25.0px; fill: #3b3d3b;}"},
{class:"subtitle{font-size:18.0px; fill: #6b6e68;}"},
{class:"source{fill: #6b6e68; font-size: 14.0px;}"},
{class:"logo{fill: #dacfc5;}"},
...
{class:"labels{font-size: 48px; fill: #ffffff; opacity: 0.5; font-weight: 400;}"},
