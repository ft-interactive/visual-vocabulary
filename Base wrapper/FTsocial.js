...
function socialFrame() {
    ...
    function frame(p) {
        ...
        var chart = p.append("svg")
            .attr("class","chart soc")
            .attr("width", width)
            .attr("height", height)
            .attr("viewBox", "0 0 " + width + " " + height);
        
        //show extent of frame
        chart.append("rect")
            .attr("width", width)
            .attr("height", height)
            .attr("style", "fill:#343334;stroke:none");
        ...
        var contentOffsetTop = chart.select("#header-soc").node().getBBox().y + chart.select("#header-soc").node().getBBox().height;
        ...
        d3.select("#socFooter").attr("y",function(){
