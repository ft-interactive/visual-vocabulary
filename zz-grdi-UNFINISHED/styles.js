...
{class:"labels{font-size:12px; fill: #000000; font-weight: 400; text-anchor: middle;}"},
...
{class:"rows{opacity: 0.1}"},
{class:"columns{opacity: 0.1}"},
{class:"cells{opacity: 1.0}"},
...
{class:"labels{font-size:20px; fill: #6b6e68; font-weight: 400; text-anchor: middle}"},
{class:"logo{fill: #dacfc5;}"},
...
{class:"labels{font-size: 38px; fill: #ffffff; opacity: 0.95; font-weight: 400; text-anchor: middle}"},
...
{class:"labels{font-size:68px; fill: #ffffff; font-weight: 400; text-anchor: middle}"},
